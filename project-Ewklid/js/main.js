(() => {
  var e = {
          914: () => {
              document.querySelectorAll(".question__accordion-point").forEach((e => {
                  e.addEventListener("click", (function() {
                      this.nextElementSibling.classList.toggle("is-hidden"), e.querySelector(".question__accordion-cross").classList.toggle("question__accordion-cross--rotate")
                  }))
              }))
          },
          199: () => {
              const e = document.querySelector("[data-opensearch]"),
                  t = document.querySelector(".header__search-modal"),
                  s = document.querySelector(".header__search-close");
              e.addEventListener("click", (function() {
                  t.classList.toggle("header__search-modal--active")
              })), s.addEventListener("click", (function() {
                  t.classList.remove("header__search-modal--active")
              })), e.addEventListener("focus", (function() {
                  t.classList.add("header__search-modal--active")
              }))
          },
          158: () => {
              ...
              e.forEach((s => {
                  s.addEventListener("click", (function() {
                      ...
                      })), s.classList.add("tab__item--active"), document.querySelector("#" + this.dataset.tab).classList.remove("is-hidden")
                  }))
              }))
          }
      },
  ...
  function s(i) {
      ...
      const e = {
          ...
          t = () => {
              var t;
              const s = null === (t = document) || void 0 === t ? void 0 : t.querySelectorAll(".fixed-block"),
      ...
      function n(e = {}, t = {}) {
          ...
          var s, i, n, a;
          const r = null === (s = document) || void 0 === s ? void 0 : s.querySelector("[data-burger]"),
              l = null === (i = document) || void 0 === i ? void 0 : i.querySelector("[data-menu]"),
              o = null === (n = document) || void 0 === n ? void 0 : n.querySelectorAll("[data-menu-item]"),
              d = null === (a = document) || void 0 === a ? void 0 : a.querySelector("[data-menu-overlay]");
          null == r || r.addEventListener("click", (s => {
              null == r || r.classList.toggle("burger--active"), null == l || l.classList.toggle("menu--active"), null != l && l.classList.contains("menu--active") ? (null == r || r.setAttribute("aria-expanded", "true"), null == r || r.setAttribute("aria-label", "Закрыть меню"), (() => {
                  var t;
                  const s = null === (t = document) || void 0 === t ? void 0 : t.querySelectorAll(".fixed-block"),
                      i = window.scrollY,
                      n = window.innerWidth - e.bodyEl.offsetWidth + "px";
                  e.htmlEl.style.scrollBehavior = "none", s.forEach((e => {
                      e.style.paddingRight = n
                  })), e.bodyEl.style.paddingRight = n, e.bodyEl.classList.add("dis-scroll"), e.bodyEl.dataset.position = i, e.bodyEl.style.top = `-${i}px`
              })()) : (null == r || r.setAttribute("aria-expanded", "false"), null == r || r.setAttribute("aria-label", "Открыть меню"), t())
          })), null == d || d.addEventListener("click", (() => {
              null == r || r.setAttribute("aria-expanded", "false"), null == r || r.setAttribute("aria-label", "Открыть меню"), r.classList.remove("burger--active"), l.classList.remove("menu--active"), t()
          })), null == o || o.forEach((e => {
          ...
          for (let n = 1; n < e.length; n += 1) {
              ...
              if (null != a && (i = a, !("undefined" != typeof window && void 0 !== window.HTMLElement ? i instanceof HTMLElement : i && (1 === i.nodeType || 11 === i.nodeType)))) {
                  ...
                  for (let s = 0, i = e.length; s < i; s += 1) {
                      ...
                      void 0 !== n && n.enumerable && (w(t[i]) && w(a[i]) ? a[i].__swiper__ ? t[i] = a[i] : y(t[i], a[i]) : !w(t[i]) && w(a[i]) ? (t[i] = {}, a[i].__swiper__ ? t[i] = a[i] : y(t[i], a[i])) : t[i] = a[i])
                  }
              }
          }
          var i;
      ...
      const M = {
              ...
              emit(...e) {
                  ...
                  let s, i, n;
                  return "string" == typeof e[0] || Array.isArray(e[0]) ? (s = e[0], i = e.slice(1, e.length), n = t) : (s = e[0].events, i = e[0].data, n = e[0].context || t), i.unshift(n), (Array.isArray(s) ? s : s.split(" ")).forEach((e => {
                  ...
                  for (let n = 0; n < p; n += 1) {
                      ...
                      if (E && e.grid.updateSlide(n, r, p, t), "none" !== r.css("display")) {
                          if ("auto" === i.slidesPerView) {
                              ...
                              if (l && (r[0].style.transform = "none"), o && (r[0].style.webkitTransform = "none"), i.roundLengths) x = e.isHorizontal() ? r.outerWidth(!0) : r.outerHeight(!0);
                              else {
                                  const e = s(a, "width"),
                                      t = s(a, "padding-left"),
                                      i = s(a, "padding-right"),
                              ...
                              l && (r[0].style.transform = l), o && (r[0].style.webkitTransform = o), i.roundLengths && (x = Math.floor(x))
                          } else x = (a - (i.slidesPerView - 1) * w) / i.slidesPerView, i.roundLengths && (x = Math.floor(x)), c[n] && (c[n].style[t("width")] = `${x}px`);
                          c[n] && (c[n].swiperSlideSize = x), f.push(x), i.centeredSlides ? (y = y + x / 2 + T / 2 + w, 0 === T && 0 !== n && (y = y - a / 2 - w), 0 === n && (y = y - a / 2 - w), Math.abs(y) < .001 && (y = 0), i.roundLengths && (y = Math.floor(y)), S % i.slidesPerGroup == 0 && u.push(y), h.push(y)) : (i.roundLengths && (y = Math.floor(y)), (S - Math.min(e.params.slidesPerGroupSkip, S)) % e.params.slidesPerGroup == 0 && u.push(y), h.push(y), y = y + x + w), e.virtualSize += x + w, T = x, S += 1
                      }
                  }
      ...
      const P = {
              slideTo: function(e = 0, t = this.params.speed, s = !0, i, n) {
                  ...
                  if (l.cssMode) {
                      ...
                      if (0 === t) {
                          ...
                          if (!a.support.smoothScroll) return T({
                              swiper: a,
                              targetPosition: s,
                              side: e ? "left" : "top"
                          }), !0;
          ...
          O = {
              loopCreate: function() {
                  ...
                  for (let e = 0; e < o.length; e += 1) n.append(g(o[e].cloneNode(!0)).addClass(s.slideDuplicateClass));
      ...
      function A(e) {
          ...
          if (Object.assign(n, {
                  ...
                  isScrolling: void 0,
                  startMoving: void 0
              }), l.startX = f, l.startY = m, n.touchStartTime = b(), t.allowClick = !0, t.updateSize(), t.swipeDirection = void 0, a.threshold > 0 && (n.allowThresholdMove = !1), "touchstart" !== c.type) {
              let e = !0;
              p.is(n.focusableElements) && (e = !1), s.activeElement && g(s.activeElement).is(n.focusableElements) && s.activeElement !== p[0] && s.activeElement.blur();
      ...
      function I(e) {
          ...
          if (void 0 === i.isScrolling) {
              let e;
              s.isHorizontal() && a.currentY === a.startY || s.isVertical() && a.currentX === a.startX ? i.isScrolling = !1 : h * h + f * f >= 25 && (e = 180 * Math.atan2(Math.abs(f), Math.abs(h)) / Math.PI, i.isScrolling = s.isHorizontal() ? e > n.touchAngle : 90 - e > n.touchAngle)
          }
      ...
      function z(e) {
          ...
          if (c > i.longSwipesMs) {
              ...
              "next" === t.swipeDirection && (f >= i.longSwipesRatio ? t.slideTo(u + m) : t.slideTo(u)), "prev" === t.swipeDirection && (f > 1 - i.longSwipesRatio ? t.slideTo(u + m) : t.slideTo(u))
          } else {
      ...
      const F = (e, t) => {
              ...
              (i.preventClicks || i.preventClicksPropagation) && a[p]("click", e.onClick, !0), i.cssMode && l[p]("scroll", e.onScroll), i.updateOnWindowResize ? e[u](o.ios || o.android ? "resize orientationchange observerUpdate" : "resize observerUpdate", _, !0) : e[u]("observerUpdate", _, !0)
          },
          q = {
              attachEvents: function() {
                  ...
                  e.onTouchStart = A.bind(e), e.onTouchMove = I.bind(e), e.onTouchEnd = z.bind(e), s.cssMode && (e.onScroll = D.bind(e)), e.onClick = G.bind(e), i.touch && !B && (t.addEventListener("touchstart", N), B = !0), F(e, "on")
              },
      ...
      class X {
          constructor(...e) {
              let t, s;
              if (1 === e.length && e[0].constructor && "Object" === Object.prototype.toString.call(e[0]).slice(8, -1) ? s = e[0] : [t, s] = e, s || (s = {}), s = y({}, s), t && !s.el && (s.el = t), s.el && g(s.el).length > 1) {
                  const e = [];
              ...
              const i = this;
              i.__swiper__ = !0, i.support = k(), i.device = function(e = {}) {
                  return E || (E = function({
                      userAgent: e
                  } = {}) {
                      const t = k(),
                      ...
                      const p = n.match(/(iPod)(.*OS\s([\d_]+))?/),
                          ...
                          h = "Win32" === i;
                      let f = "MacIntel" === i;
                      return !c && f && t.touch && ["1024x1366", "1366x1024", "834x1194", "1194x834", "834x1112", "1112x834", "768x1024", "1024x768", "820x1180", "1180x820", "810x1080", "1080x810"].indexOf(`${r}x${l}`) >= 0 && (c = n.match(/(Version)\/([\d.]+)/), c || (c = [0, 1, "13_0_0"]), f = !1), d && !h && (a.os = "android", a.android = !0), (c || u || p) && (a.os = "ios", a.ios = !0), a
                  }(e)), E
              }({
                  userAgent: s.userAgent
              }), i.browser = (x || (x = function() {
                  const e = o();
                  return {
                      isSafari: function() {
              ...
              }()), x), i.eventsListeners = {}, i.eventsAnyListeners = [], i.modules = [...i.__modules__], s.modules && Array.isArray(s.modules) && i.modules.push(...s.modules);
              const n = {};
              i.modules.forEach((e => {
                  e({
                      swiper: i,
              ...
              const a = y({}, V, n);
              return i.params = y({}, a, Y, s), i.originalParams = y({}, i.params), i.passedParams = y({}, s), i.params && i.params.on && Object.keys(i.params.on).forEach((e => {
          ...
          slidesPerViewDynamic(e = "current", t = !1) {
              ...
              if (s.centeredSlides) {
                  ...
                  for (let e = l + 1; e < i.length; e += 1)(t ? n[e] + a[e] - n[l] < r : n[e] - n[l] < r) && (o += 1);
              else
      ...
      U.use([function({
          ...
          function d() {
              ...
              if ("fraction" === s.type && (d.find(J(s.currentClass)).text(s.formatFractionCurrent(c + 1)), d.find(J(s.totalClass)).text(s.formatFractionTotal(p))), "progressbar" === s.type) {
                  let t;
                  t = s.progressbarOpposite ? e.isHorizontal() ? "vertical" : "horizontal" : e.isHorizontal() ? "horizontal" : "vertical";
                  const i = (c + 1) / p;
                  let n = 1,
                      a = 1;
                  "horizontal" === t ? n = i : a = i, d.find(J(s.progressbarFillClass)).transform(`translate3d(0,0,0) scaleX(${n}) scaleY(${a})`).transition(e.params.speed)
              }
          ...
          function c() {
              ...
              if ("bullets" === t.type) {
                  ...
                  n.html(a), e.pagination.bullets = n.find(J(t.bulletClass))
              }
          ...
          function u() {
              ...
              s.removeClass(t.hiddenClass), s.removeClass(t.modifierClass + t.type), s.removeClass(t.modifierClass + e.params.direction), e.pagination.bullets && e.pagination.bullets.removeClass && e.pagination.bullets.removeClass(t.bulletActiveClass), t.clickable && s.off("click", J(t.bulletClass))
          }
          s("init", (() => {
              p(), c(), d()
          })), s("activeIndexChange", (() => {
          ...
          e.autoplay = {
              ...
              e.params.autoplay.enabled && (l(), r().addEventListener("visibilitychange", c), e.params.autoplay.pauseOnMouseEnter && (e.$el.on("mouseenter", u), e.$el.on("mouseleave", h)))
              ...
              e.$el.off("mouseenter", u), e.$el.off("mouseleave", h), e.autoplay.running && o(), r().removeEventListener("visibilitychange", c)
  ...
  document.addEventListener('mouseup', function() {
    var element = document.querySelector('.question__accordion-point');
